...
class _LocationDropdownsState extends State<LocationDropdowns> {
  ...
  List<String> getCitiesList(int stateIndex) {
    return distArr[stateIndex].split("|").map((city) => city.trim()).toList();
  }
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
            ...
            Padding(
              ...
              child: DropdownButton<String>(
                ...
                items: [
                  ...
                  for (var city
                      in getCitiesList(stateArr.indexOf(selectedState)))
          ...
          //     ),
          //     suggestionsCallback: (pattern) async {
          //       return getCitiesList(stateArr.indexOf(selectedState))
          //           .where((city) =>
          ...
          //       ),
          //     ),
          //     items: getCitiesList(stateArr.indexOf(selectedState)),
          //     onChanged: (value) {
          //       setState(() {
          //         selectedCity = value!;
          //       });
